            ...
            <ul
                ...
                <li>
                    <button id="dropdownNavbarLink" data-dropdown-toggle="dropdownNavbar"
                        class="flex items-center justify-between w-full font-poppins cursor-pointer px-3 py-2 capitalize rounded md:bg-transparent {{ route('inhouse') == url()->current() || route('modul') == url()->current() || route('ebook') == url()->current() || route('webinar') == url()->current() || route('ecourse') == url()->current() || route('bootcamp') == url()->current() || route('eskul') == url()->current() ? 'md:text-tombol text-white bg-tombol' : 'text-white md:text-cardhitam' }}  hover:bg-tombol hover:text-white md:hover:bg-transparent md:border-0 md:hover:text-tombol">
                        Layanan Kami
                    ...
                    <div id="dropdownNavbar"
                        ...
                        <ul class="py-2 text-sm font-bold" aria-labelledby="dropdownLargeButton">
                            ...
                            <li>
                                <a href="/ebook"
                                    class="block px-4 py-2 hover:bg-tombol hover:text-white {{ route('ebook') == url()->current() ? 'text-white bg-tombol' : 'text-primary font-bold' }}">
                                    E-Book
                                </a>
                            </li>
                            <li>
                ...
                <li>
                    <a href="https://edu.excellentteam.id/artikel/" target="_blank"
