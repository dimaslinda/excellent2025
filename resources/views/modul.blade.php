            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5 place-items-center">
                @forelse ($modulAjar as $item)
                    <div
                        ...
                        <div class="max-h-[550px] overflow-hidden">
                            <img src="{{ $item->getFirstMediaUrl('modul') }}" class="h-full w-full object-cover"
                                alt="modul">
                        </div>
                        <div class="p-6">
                            <div
                ...
                @empty
                    <div class="col-span-full text-center">
                        <h2 class="text-2xl font-bold text-gray-500">Mohon maaf, belum ada data Modul Ajar yang tersedia
                        </h2>
                ...
                {{-- <div
                    class="max-w-sm rounded-xl cursor-pointer flex flex-col overflow-hidden bg-white drop-shadow-2xl shadow-2xl">
                    <div class="max-h-[550px] overflow-hidden">
                        <img src="{{ asset('img/general/modul-1.webp') }}" class="h-full w-full object-cover"
                            alt="modul">
                    </div>
                    <div class="p-6">
                        <div
                ...
                <div
                    class="max-w-sm rounded-xl cursor-pointer flex flex-col overflow-hidden bg-white drop-shadow-2xl shadow-2xl">
                    <div class="max-h-[550px] overflow-hidden">
                        <img src="{{ asset('img/general/modul-2.webp') }}" class="h-full w-full object-cover"
                            alt="modul">
                    </div>
                    <div class="p-6">
                        <div
                ...
                <div
                    class="max-w-sm rounded-xl cursor-pointer flex flex-col overflow-hidden bg-white drop-shadow-2xl shadow-2xl">
                    <div class="max-h-[550px] overflow-hidden">
                        <img src="{{ asset('img/general/modul-3.webp') }}" class="h-full w-full object-cover"
                            alt="modul">
                    </div>
                    <div class="p-6">
                        <div
                ...
                <div
                    class="max-w-sm rounded-xl cursor-pointer flex flex-col overflow-hidden bg-white drop-shadow-2xl shadow-2xl">
                    <div class="max-h-[550px] overflow-hidden">
                        <img src="{{ asset('img/general/modul-4.webp') }}" class="h-full w-full object-cover"
                            alt="modul">
                    </div>
                    <div class="p-6">
                        <div
                ...
                <div
                    class="max-w-sm rounded-xl cursor-pointer flex flex-col overflow-hidden bg-white drop-shadow-2xl shadow-2xl">
                    <div class="max-h-[550px] overflow-hidden">
                        <img src="{{ asset('img/general/modul-5.webp') }}" class="h-full w-full object-cover"
                            alt="modul">
                    </div>
                    <div class="p-6">
                        <div
                ...
                <div
                    class="max-w-sm rounded-xl cursor-pointer flex flex-col overflow-hidden bg-white drop-shadow-2xl shadow-2xl">
                    <div class="max-h-[550px] overflow-hidden">
                        <img src="{{ asset('img/general/modul-6.webp') }}" class="h-full w-full object-cover"
                            alt="modul">
                    </div>
                    <div class="p-6">
                        <div
                ...
                <div
                    class="max-w-sm rounded-xl cursor-pointer flex flex-col overflow-hidden bg-white drop-shadow-2xl shadow-2xl">
                    <div class="max-h-[550px] overflow-hidden">
                        <img src="{{ asset('img/general/modul-7.webp') }}" class="h-full w-full object-cover"
                            alt="modul">
                    </div>
                    <div class="p-6">
                        <div
